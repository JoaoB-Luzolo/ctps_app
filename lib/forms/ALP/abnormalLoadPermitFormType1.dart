...
class AbnormalLoadPermitFormType1 extends StatefulWidget {
  const AbnormalLoadPermitFormType1({
    super.key,
  });

  @override
  State<AbnormalLoadPermitFormType1> createState() =>
      _AbnormalLoadPermitViewState();
}

class _AbnormalLoadPermitViewState extends State<AbnormalLoadPermitFormType1> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.orange,
        title: Text(
            'Abnormal Load/Vehicle Permit Type 1'), // Set the title of the AppBar
      ),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Center(
                child: Text(
                  'Sketch of Abnormal Vehicle Type 1',
                  style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold),
                ),
              ),
              SizedBox(
