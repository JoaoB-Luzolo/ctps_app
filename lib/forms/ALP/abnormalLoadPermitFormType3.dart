...
class AbnormalLoadPermitFormType3 extends StatefulWidget {
  const AbnormalLoadPermitFormType3({
    super.key,
  });

  @override
  State<AbnormalLoadPermitFormType3> createState() =>
      _AbnormalLoadPermitViewState();
}

class _AbnormalLoadPermitViewState extends State<AbnormalLoadPermitFormType3> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.orange,
        title: Text(
            'Abnormal Load/Vehicle Permit Type 3'), // Set the title of the AppBar
      ),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Center(
                child: Text(
                  'Sketch of Abnormal Vehicle Type 3',
                  style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold),
                ),
              ),
              SizedBox(
