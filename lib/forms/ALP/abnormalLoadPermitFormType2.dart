...
class AbnormalLoadPermitFormType2 extends StatefulWidget {
  const AbnormalLoadPermitFormType2({
    super.key,
  });

  @override
  State<AbnormalLoadPermitFormType2> createState() =>
      _AbnormalLoadPermitViewState();
}

class _AbnormalLoadPermitViewState extends State<AbnormalLoadPermitFormType2> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.orange,
        title: Text(
            'Abnormal Load/Vehicle Permit Type 2'), // Set the title of the AppBar
      ),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Center(
                child: Text(
                  'Sketch of Abnormal Vehicle Type 2',
                  style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold),
                ),
              ),
              SizedBox(
