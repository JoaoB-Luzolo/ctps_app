...
class CrossBorderPermitCopy extends StatefulWidget {
  final Map? cbp;
  const CrossBorderPermitCopy({super.key, this.cbp});
  @override
  State<CrossBorderPermitCopy> createState() =>
      _CrossBorderPermitEditFormState();
}

class _CrossBorderPermitEditFormState extends State<CrossBorderPermitCopy> {
